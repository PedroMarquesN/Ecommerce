...
<template>
    ...
    <div class="col-span-2 col-start-1 flex flex-col justify-between border-b py-3 sm:flex-row">
        <p class="font-medium">Visão Geral</p>
        <select class="text-slate-500 hover:bg-slate-200 rounded-lg border-2 px-4 py-2 font-medium focus:outline-none focus:ring">
            ...
            <option value="last-month">Últimos 2 Meses</option>
            <option value="last-month">Este Ano</option>
        </select>
    </div>
    <div class="col-span-2 -mx-4 bg-gradient-to-t from-indigo-500 to-blue-500 px-4 py-8 sm:col-span-1 sm:mx-0 sm:rounded-xl sm:py-4">
        <p class="mb-4 font-medium text-indigo-100">Casos em Andamento</p>
        ...
        <div class="flex flex-wrap justify-between">
            <div class="flex flex-col items-center px-4 py-1">
                ...
                <p class="text-xs font-medium text-indigo-100">Orçamento</p>
            </div>
            ...
            <div class="mb-1 flex flex-col items-center rounded-2xl bg-white px-4 py-1 sm:mr-1 sm:mb-0">
                ...
                <p class="text-xs font-medium text-indigo-500">Reembolsos</p>
            </div>
            <div class="flex flex-col items-center px-4 py-1">
    ...
    <div class="col-span-2 grid grid-cols-2 gap-4 py-4 sm:col-span-1 sm:gap-8 sm:px-4">
        <div class="">
            ...
            <span class="bg-slate-200 text-slate-600 rounded-full px-2 py-0.5 text-xs font-medium">Rascunhos</span>
        </div>
        <div class="">
            <p class="text-lg font-bold">621</p>
            <p class="text-slate-400 mb-2 font-medium">$230,000</p>
            <span class="rounded-full bg-indigo-200 px-2 py-0.5 text-xs font-medium text-indigo-600">Aguardando Aprovação</span>
        </div>
        <div class="">
            <p class="text-lg font-bold">68</p>
            <p class="text-slate-400 mb-2 font-medium">$230,000</p>
            <span class="rounded-full bg-yellow-200 px-2 py-0.5 text-xs font-medium text-yellow-700">Enviados aos Clientes</span>
        </div>
        <div class="">
            <p class="text-lg font-bold">970</p>
            <p class="text-slate-400 mb-2 font-medium">$230,000</p>
            <span class="rounded-full bg-green-200 px-2 py-0.5 text-xs font-medium text-green-600">Assinando</span>
        </div>
    </div>
    <div class="col-span-2 col-start-1 grid grid-cols-2 gap-6 border-t py-4 sm:grid-cols-4 sm:px-4 sm:py-8">
        <div class="">
            <p class="text-slate-500 text-sm">Receita</p>
            <p class="text-xl font-medium">$924,883</p>
        </div>
        <div class="">
            <p class="text-slate-500 text-sm">Passivos</p>
            <p class="text-xl font-medium">$924,883</p>
        </div>
        <div class="">
            <p class="text-slate-500 text-sm">Lucro</p>
            <p class="text-xl font-medium">$213,002</p>
        </div>
        <div class="">
            <p class="text-slate-500 text-sm">Meta</p>
